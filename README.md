...
| [Borrowers reliability research](https://github.com/Hanna412/data-science-yandex-practicum-/tree/main/02_borrowers_reliability)| Data of the bank's credit department. It is necessary to find out whether the marital status and the number of children of the client affect the repayment of the loan on time. The input data from the bank is statistics on the solvency of customers. The results will be used for a credit scoring model, a special system that evaluates a potential borrower's reliability.  | Python, Pandas  |
| [Research of real estate ads](https://github.com/Hanna412/data-science-yandex-practicum-/tree/main/03_real_estate)| Data is an archive of ads for apartments for sale in St. Petersburg and its suburbs for several years. It is necessary to determine the market price of real estate.  A research analysis of the data was carried out and the parameters affecting the price of the objects were determined. | Python, Pandas, Matplotlib |
